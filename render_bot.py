...
BOT_TOKEN = "8372266918:AAGMkYzH0QvmxGJVrrTXvF8nzT7KXjj1O40"
...
def format_cybersecurity_report(user_data, number, record_count, current_time):
    ...
    # Determine network
    network = 'Unknown'
    if 'JIO' in circle.upper():
        network = 'JIO'
    elif 'VODAFONE' in circle.upper():
        network = 'VODAFONE'
    elif 'AIRTEL' in circle.upper():
        network = 'AIRTEL'
...
@app.route('/')
def index():
    return "Oliver Exploits Bot is Running!"
...
# Create application instance globally
...
def main():
    ...
    print("📱 Status: OPERATIONAL (WEBHOOK MODE)")
    print("=" * 50)
